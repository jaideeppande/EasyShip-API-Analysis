...
```json
{
  ...
  "paths": {
    "/2024-11/companies": {
      "post": {
        ...
        "description": "Create a new company in specific organization.\n\nRequired authorization scope: `enterprise.company:write`\n",
        "security": [
          {
            "OAuth2": [
              "enterprise.company"
        ...
        "responses": {
          "201": {
            "description": "company successfully created with duplicated email",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "company": {
                        "address": {
                          ...
                          "id": "fe285fc4-9520-47f7-b770-28720576f766",
                          "line_1": "Kennedy Town",
                          "line_2": "Block 3",
                          "postal_code": "0000",
                          "state": null
                    ...
                    "summary": "company successfully created"
                  },
                  "duplicate_email": {
                    "value": {
                      "company": {
                        "address": {
                          ...
                          "contact_name": "John Smith",
                          "contact_phone": "+852-3008-5678",
                          "id": "480352d3-6ad4-431c-b7e8-e151618082a8",
                          "line_1": "Kennedy Town",
                          "line_2": "Block 3",
                          "postal_code": "0000",
                          "state": null
                    ...
                    "summary": "company successfully created with duplicated email"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/company_single_after_create"
                }
              }
            }
          },
              ...
              "examples": {
                "company_successfully_created": {
                  ...
                  "value": {
                    ...
                    "external_id": "external_id",
                    "country_alpha2": "HK",
                    "organization_id": "01563646-58c1-4607-8fe0-cae3e33c0001"
                  }
                },
                "company_successfully_created_with_duplicated_email": {
                  "summary": "company successfully created with duplicated email",
                  "value": {
                    "owner": {
                      "email": "test_99@easyship.com",
                ...
                "organization_not_found": {
                  ...
                  "value": {
                    ...
                    "external_id": "external_id",
                    "country_alpha2": "HK",
                    "organization_id": "01563646-58c1-4607-8fe0-cae3e33c0008"
                  }
                },
                "invalid_params": {
                  "summary": "invalid params",
  ...
  "components": {
    ...
    "schemas": {
      "company_single_after_create": {
        "type": "object",
        "description": "Account Detail",
        "additionalProperties": false,
        "properties": {
          "company": {
            "$ref": "#/components/schemas/CompanyAfterCreate"
          },
          "meta": {
      ...
      "CompanyAfterCreate": {
        ...
        "properties": {
          ...
          "easyship_company_id": {
            "$ref": "#/components/schemas/Company/properties/easyship_company_id"
          },
          "external_id": {
            "$ref": "#/components/schemas/Company/properties/external_id"
          },
          "created_at": {
            "$ref": "#/components/schemas/Company/properties/created_at"
          },
          "updated_at": {
            "$ref": "#/components/schemas/Company/properties/updated_at"
          },
          "owner": {
            "$ref": "#/components/schemas/CompanyOwner"
          },
