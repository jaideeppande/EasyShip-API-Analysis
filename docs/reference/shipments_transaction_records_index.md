  ...
  "paths": {
    "/2024-09/shipments/{easyship_shipment_id}/transaction_records": {
      "get": {
        ...
        "operationId": "shipments_transaction_records_index",
        "description": "List transaction records for a shipment.\n\nRequired authorization scope: `public.transaction_record:read`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "list of transaction records for the shipment",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "list of transaction records for the shipment"
                  }
                },
                "schema": {
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "List all Transaction Records",
                            "url": "https://developers.easyship.com/reference/transactions_index"
                          }
                        ],
