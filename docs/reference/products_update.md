  ...
  "paths": {
    "/2024-09/products/{product_id}": {
      "patch": {
        ...
        "description": "Update a single product in your account.\n\nRequired authorization scope: `public.product:write`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          {
            ...
            "in": "path",
            "required": true,
            "description": "Product ID provided when updating product",
            "schema": {
              "type": "string"
            }
          }
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            ...
                            "url": "https://developers.easyship.com/reference/products_update"
                          }
                        ],
