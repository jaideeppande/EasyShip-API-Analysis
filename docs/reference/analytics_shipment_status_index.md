...
```json
{
  ...
  "paths": {
    "/2024-09/analytics/shipment_status": {
      "get": {
        ...
        "operationId": "analytics_shipment_status_index",
        "description": "Retrieve shipment status. Possible statuses:\n- Label Pending\n- Label Rejected\n- Label Ready\n- Pickup/Drop-off in Progress\n- In Transit to Customer\n- Failed Delivery Attempt\n- Exception\n\nRequired authorization scope: `public.analytics:read`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "list of shipments count group by status",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "list of shipments count group by status"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/analytics_shipment_status_data"
                }
              }
            }
          },
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "List Analytics Shipment Status Data",
                            "url": "https://developers.easyship.com/reference/analytics_shipment_status_index"
                          }
                        ],
  ...
  "components": {
    ...
    "schemas": {
      "analytics_shipment_status_data": {
        "type": "object",
        "description": "Summary Analytics Shipment Status Data",
        "additionalProperties": false,
        "properties": {
          "analytics_shipment_status": {
            "$ref": "#/components/schemas/AnalyticsShipmentStatus"
          },
          "meta": {
      ...
      "AnalyticsShipmentStatus": {
        ...
        "properties": {
          ...
          "in_progress_shipments_count": {
            "type": "integer",
            "description": "Total number of `in progress` shipments during report period"
          },
          "completed_shipments_count": {
            "type": "integer",
            "description": "Total number of completed shipments during report period"
          },
          "in_progress_shipments": {
            "type": "array",
            "items": {
              ...
              "properties": {
                ...
                "count": {
                  "type": "integer",
                  "description": "Number of shipments with a specific status"
                }
              }
            }
          }
