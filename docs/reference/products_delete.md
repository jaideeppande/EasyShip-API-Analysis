  ...
  "paths": {
    "/2024-09/products/{product_id}": {
      "delete": {
        ...
        "description": "Delete a single product from your account.\n\nRequired authorization scope: `public.product:write`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          {
            ...
            "in": "path",
            "required": true,
            "description": "Product ID provided when deleting product",
            "schema": {
              "type": "string"
            }
          }
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            ...
                            "url": "https://developers.easyship.com/reference/products_delete"
                          }
                        ],
