  ...
  "paths": {
    "/2024-09/shipping_rules/{shipping_rule_id}/actions": {
      "post": {
        ...
        "description": "Create action for a shipping rule.\n\nRequired authorization scope: `public.shipping_rule:write`\n",
        "security": [
          {
            "Bearer": []
          }
                    ...
                    "value": {
                      "error": {
                        ...
                        "details": [
                          ...
                          "discriminator propertyName type does not exist in value {} in #/components/schemas/ShippingRuleActionCreate/discriminator"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
