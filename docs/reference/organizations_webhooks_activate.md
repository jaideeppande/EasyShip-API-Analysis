...
Activates a single webhook for your organization.
...
```json
{
  ...
  "paths": {
    "/2024-11/organizations/{organization_id}/webhooks/{webhook_id}/activate": {
      "post": {
        "summary": "Activate a Webhook",
        "tags": [
          "Webhooks"
        ],
        "operationId": "organizations_webhooks_activate",
        "description": "Activates a single webhook for your organization.\n\nRequired authorization scope: `enterprise.webhook:write`\n",
        "security": [
          {
            "OAuth2": [
              "enterprise.webhook"
        ...
        "responses": {
              ...
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "success": {
                        "message": "Webhook successfully activated."
                      },
                      "meta": {
                        "request_id": "01563646-58c1-4607-8fe0-cae3e92c4477"
                      }
                    },
                    "summary": "webhook successfully activated"
                  }
                },
                "schema": {
          ...
          "400": {
            "description": "failed to activate webhook",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "error": {
                        "code": "api_error",
                        "details": [
                          "Failed to activate webhook. Reason: "
                        ],
                    ...
                    "summary": "failed to activate webhook"
                  }
                },
                "schema": {
