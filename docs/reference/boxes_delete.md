  ...
  "paths": {
    "/2024-09/boxes/{box_id}": {
      "delete": {
        ...
        "description": "Delete a box from your account.\n\nRequired authorization scope: `public.box:write`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "box successfully deleted",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "box successfully deleted"
                  }
                },
                "schema": {
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            "kind": "documentation",
                            "name": "Delete a Box",
                            "url": "https://developers.easyship.com/reference/boxes_delete"
                          }
                        ],
