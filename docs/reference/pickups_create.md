...
```json
{
  ...
  "paths": {
    "/2024-09/pickups": {
      "post": {
        ...
        "responses": {
          "201": {
            "description": "pickup successfully created",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "pickup successfully created"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/pickup_single"
                }
              }
            }
          },
          "422": {
            "description": "slots not found for provided courier",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "error": {
                        ...
                        "details": [
                          "This Courier doesn't provide a Pickup service"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
                          ...
                          },
                          {
                            ...
                            "url": "https://developers.easyship.com/reference/pickups_create"
                          },
                          {
                            "kind": "how-to-guide",
                    ...
                    "summary": "slots not found for provided courier"
                  }
                },
                "schema": {
  ...
  "components": {
    ...
    "schemas": {
      ...
      "PickupCreate": {
        "type": "object",
        "description": "Pickup params",
        "additionalProperties": false,
        "properties": {
          "courier_service_id": {
            "type": "string",
            "format": "uuid",
            "description": "The unique identifier for the courier service."
          },
          "time_slot_id": {
            "type": "string",
            "format": "uuid",
            "nullable": true,
            "description": "Time Slot ID from [Courier List Available Pickup Slots](https://developers.easyship.com/reference/courier_services_pickup_slots_index) API. Optional if `selected_from_time` and `selected_to_time` are provided."
          },
          "selected_date": {
            "type": "string",
            "format": "date",
            "description": "Selected date for pickup"
          },
          "selected_from_time": {
            "type": "string",
            "nullable": true,
            "description": "Selected from time for pickup. Optional if a `time_slot_id` is provided."
          },
          "selected_to_time": {
            "type": "string",
            "nullable": true,
            "description": "Selected to time for pickup. Optional if a `time_slot_id` is provided."
          },
          "easyship_shipment_ids": {
            "type": "array",
            "description": "All shipments to be requested. Shipments must have the same courier and their labels must be pending or generated.",
            "items": {
              "type": "string"
            }
          }
