  ...
  "paths": {
    "/2024-09/couriers/{courier_id}": {
      "get": {
        ...
        "operationId": "couriers_show",
        "description": "Retrieve details of a couriers.\n\nRequired authorization scope: `public.courier:read`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "returns a courier successfully",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "returns a courier successfully"
                  }
                },
                "schema": {
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            "kind": "documentation",
                            "name": "Get a Courier",
                            "url": "https://developers.easyship.com/reference/courier_accounts_show"
                          }
                        ],
