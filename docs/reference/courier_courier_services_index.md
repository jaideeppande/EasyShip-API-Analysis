  ...
  "paths": {
    "/2024-09/couriers/{courier_id}/courier_services": {
      "get": {
        ...
        "operationId": "courier_courier_services_index",
        "description": "Retrieve a list of courier services for selected courier.\n\nRequired authorization scope: `public.courier_service:read`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          ...
          {
            "name": "prohibit_dangerous_goods",
            "in": "query",
            "required": false,
            "description": "Filter records if the courier does not accept dangerous goods",
            "schema": {
              "type": "boolean"
            }
          },
                      ...
                      "courier_services": [
                        {
                          ...
                          "ioss_support": null,
                          "logo_url": "aramex",
                          "name": "My DHL 1 - DHL Express",
                          "nickname": "My DHL 32",
                          "official_name": "DHL Express",
