      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "example": "URL",
            "required": false,
            "description": "Document format (Options: `URL`, `PDF`, `PNG`). `URL` will be a link to a .pdf file, `PNG` and `PDF` will be an array of base64 encoded strings.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "example": "4x6",
            "required": false,
            "description": "Label page size (Options: `A4`, `A5`, `4x6`). Some couriers only offer A4 labels.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "example": "A4",
            "required": false,
            "description": "Commercial invoice page size (Options: `A4`, `4x6`). An invoice will only be provided if necessary. Some couriers offer a paperless invoice service.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "example": "none",
            "required": false,
            "description": "Packing slip page size (Options: `none`, `A4`, `4x6`).",
            "schema": {
              "type": "string"
            }
          }
                  ...
                  "rates_with_duty_breakdown": {
                    "value": {
                      "shipment": {
                        ...
                        "tracking_page_url": "https://api.easyship.com:9003/shipment-tracking/ESSG10006001",
                        "trackings": [
                          {
                            "alternate_tracking_number": null,
                            "handler": "aramex",
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            "kind": "documentation",
                            "name": "Get a Shipment",
                            "url": "https://developers.easyship.com/reference/shipments_show"
                          },
                          {
                            "kind": "how-to-guide",
