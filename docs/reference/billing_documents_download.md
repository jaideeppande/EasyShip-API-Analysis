  ...
  "paths": {
    "/2024-09/billing_documents/{id}/download": {
      "get": {
        ...
        "operationId": "billing_documents_download",
        "security": [
          {
            "Bearer": []
          }
        ],
        "description": "Download the Billing Document in PDF format.\n\nRequired authorization scope: `public.billing_document:read`\n",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "responses": {
          "200": {
            "description": "billing document in PDF"
          },
          "404": {
                  ...
                  "default": {
                    "value": {
                      "error": {
                        ...
                        "details": [
                          "The Billing Document was not found"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
                          ...
                          {
                            "kind": "documentation",
                            "name": "Download Billing Document",
                            "url": "https://developers.easyship.com/reference/billing_documents_download"
                          }
                        ],
