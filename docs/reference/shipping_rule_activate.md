  ...
  "paths": {
    "/2024-09/shipping_rules/{id}/activate": {
      "post": {
        ...
        "operationId": "shipping_rule_activate",
        "description": "Activate specific shipping rule.\n\nRequired authorization scope: `public.shipping_rule:write`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "shipping rule successfully activated",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "shipping rule successfully activated"
                  }
                },
                "schema": {
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Activate a Shipping Rule",
                            "url": "https://developers.easyship.com/reference/shipping_rule_activate"
                          }
                        ],
                  ...
                  "default": {
                    "value": {
                      "error": {
                        ...
                        "details": [
                          "The Shipping Rule was not found"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
