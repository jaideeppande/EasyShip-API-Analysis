# Get a Company Onboarding

Retrieve a Company Onboarding.
...
```json
{
  ...
  "paths": {
    "/2024-11/company_onboardings/{external_id}": {
      "parameters": [
        {
          "name": "external_id",
          "in": "path",
          "required": true,
          "description": "External ID provided when creating the company onboarding",
          "schema": {
            "type": "string"
          }
        }
      ...
      "get": {
        "summary": "Get a Company Onboarding",
        "tags": [
          "Companies"
        ],
        "operationId": "company_onboardings_show",
        "description": "Retrieve a Company Onboarding.\n\nRequired authorization scope: `enterprise.company:read`\n",
        "security": [
          {
            "OAuth2": [
              "enterprise.company"
        ...
        "responses": {
          "200": {
            "description": "Company onboarding found",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "Company onboarding found"
                  }
                },
                "schema": {
          ...
          "404": {
            "description": "Company onboarding not found",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "error": {
                        ...
                        "details": [
                          "The Company Onboarding was not found"
                        ],
                    ...
                    "summary": "Company onboarding not found"
                  }
                },
                "schema": {
