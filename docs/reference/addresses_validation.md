...
See the [Domestic Address Validation](https://developers.easyship.com/reference/addresses_validation_domestic) endpoint for more details.
...
```json
{
  ...
  "paths": {
    "/2024-09/addresses/validations": {
      "post": {
        "summary": "Validate a single address",
        "tags": [
          "Addresses"
        ],
        "operationId": "addresses_validation",
                    ...
                    "value": {
                      "error": {
                        ...
                        "details": [
                          ...
                          "#/components/schemas/AddressValidationCreate missing required parameters: line_1, city, country_alpha2"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/AddressValidationCreate"
              },
              "examples": {
