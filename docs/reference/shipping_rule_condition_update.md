  ...
  "paths": {
    "/2024-09/shipping_rules/{shipping_rule_id}/conditions/{condition_id}": {
      "patch": {
        ...
        "operationId": "shipping_rule_condition_update",
        "description": "Update shipping rule condition.\n\nRequired authorization scope: `public.shipping_rule:write` \n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "path",
            "required": true,
            "description": "Condition ID provided when creating",
            "schema": {
              "type": "string"
            }
          }
        ...
        "responses": {
          "200": {
            "description": "condition successfully updated",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "condition": {
                        ...
                        "type": "match_platform_name"
                      },
                      "meta": {
                        "request_id": "01563646-58c1-4607-8fe0-cae3e92c4477"
                      }
                    },
                    "summary": "condition successfully updated"
                  }
                },
                "schema": {
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Update Condition of a Shipping Rule",
                            "url": "https://developers.easyship.com/reference/shipping_rule_condition_update"
                          },
                          {
                            "kind": "how-to-guide",
                    ...
                    "value": {
                      "error": {
                        ...
                        "details": [
                          ...
                          "discriminator mapped schema #/components/schemas/test no condition does not exist in #/components/schemas/ShippingRuleConditionCreate/discriminator"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              ...
              "examples": {
                "condition_successfully_updated": {
                  "summary": "condition successfully updated",
                  "value": {
                    "type": "match_platform_name",
                    "options": {
