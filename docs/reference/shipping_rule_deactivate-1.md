...
```json
{
  ...
  "paths": {
    "/2024-11/shipping_rules/{shipping_rule_id}/deactivate": {
      "post": {
        "summary": "Deactivate a Shipping Rule",
        "tags": [
          "Shipping Rules"
        ],
        "operationId": "shipping_rule_deactivate",
        "description": "Deactivate specific shipping rule.\n\nRequired authorization scope: `enterprise.shipping_rule:write`\n",
        "security": [
          {
            "OAuth2": [
        ...
        "responses": {
          "200": {
            "description": "shipping rule successfully deactivated",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                        ...
                        "actions": [
                          {
                            ...
                            "options": {
                              "never_courier_service_ids": [
                                "001563646-58c1-4607-8fe0-cae3e33c001"
                              ]
                            },
                    ...
                    "summary": "shipping rule successfully deactivated"
                  }
                },
                "schema": {
