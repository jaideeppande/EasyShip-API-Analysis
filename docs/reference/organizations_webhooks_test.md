...
```json
{
  ...
  "paths": {
    "/2024-11/organizations/{organization_id}/webhooks/{webhook_id}/test": {
      "post": {
        "summary": "Test a Webhook",
        "tags": [
          "Webhooks"
        ],
        "operationId": "organizations_webhooks_test",
        "description": "Test a single webhook in the organization. (The company ID of the organization owner will be included in the `X-EASYSHIP-COMPANY-ID` header.)\n\nRequired authorization scope: `enterprise.webhook:write`\n",
        "security": [
          {
            "OAuth2": [
              "enterprise.webhook"
                  ...
                  "default": {
                    "value": {
                      "error": {
                        ...
                        "details": [
                          "event_type 'Unknown_event_type' is invalid"
                        ],
