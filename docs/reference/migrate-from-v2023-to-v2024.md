...
To use the new Public API `2024-09`, you must set up a new API Integration (see [Scopes](https://developers.easyship.com/reference/scopes)).
...
Refer to the [Create a Batch of Labels](https://developers.easyship.com/reference/batch_labels_create) documentation for complete usage details.
