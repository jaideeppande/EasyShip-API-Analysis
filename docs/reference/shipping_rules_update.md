...
```json
{
  ...
  "paths": {
    "/2024-09/shipping_rules/{shipping_rule_id}": {
      "patch": {
        ...
        "operationId": "shipping_rules_update",
        "description": "Update a shipping rule.\n\nRequired authorization scope: `public.shipping_rule:write` \n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "shipping rule successfully updated",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "shipping_rule": {
                        ...
                        "actions": [
                          {
                            ...
                            "type": "add_preferred_courier_service"
                          }
                        ],
                        "active": true,
                        "checkout_restrictive": false,
                        "conditions": [
                          {
                        ...
                        "description": "All shipments going to France, always include insurance",
                        "id": "01563646-58c1-4607-8fe0-cae3e33c0001",
                        "name": "Updated Shipping Rule",
                        "priority": 0,
                    ...
                    "summary": "shipping rule successfully updated"
                  }
                },
                "schema": {
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Update a Shipping Rule",
                            "url": "https://developers.easyship.com/reference/shipping_rules_update"
                          },
                          {
                            "kind": "how-to-guide",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              ...
              "examples": {
                "shipping_rule_successfully_updated": {
                  "summary": "shipping rule successfully updated",
                  "value": {
                    "name": "Updated Shipping Rule",
  ...
  "components": {
    ...
    "schemas": {
      ...
      "ShippingRuleUpdate": {
        "type": "object",
        "description": "Shipping Rule Update Params",
        "additionalProperties": false,
        "properties": {
          "name": {
            "$ref": "#/components/schemas/ShippingRule/properties/name"
          },
          "description": {
            "$ref": "#/components/schemas/ShippingRule/properties/description"
          },
          ...
          "priority": {
            "type": "integer",
            "description": "A smaller value represent higher priority. High priority shipping rule would be execute first."
          },
          "conditions": {
            "type": "array",
            "minItems": 1,
