...
```json
{
  ...
  "paths": {
    "/2024-09/analytics/sale_channels": {
      "get": {
        "summary": "List Analytics Sale Channels Data",
        "tags": [
          "Analytics"
        ],
        "operationId": "analytics_sale_channels_index",
        ...
        "responses": {
          "200": {
            "description": "list of sale channels",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "list of sale channels"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/analytics_sale_channels_data"
                }
              }
            }
          },
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "List Analytics Sale Channels Data",
                            "url": "https://developers.easyship.com/reference/analytics_sale_channels_index"
                          }
                        ],
  ...
  "components": {
    ...
    "schemas": {
      "analytics_sale_channels_data": {
        "type": "object",
        "description": "Summary Analytics Sale Channels Data",
        "additionalProperties": false,
        "properties": {
          "analytics_sale_channels": {
            "$ref": "#/components/schemas/AnalyticsSaleChannel"
          },
          "meta": {
          ...
          "channels": {
            ...
            "items": {
              ...
              "properties": {
                ...
                "shipments_count": {
                  "type": "integer",
                  "description": "Number of shipments for a specific channel"
                },
                "percentage": {
                  "type": "number",
                  "description": "Percentage of shipments for a specific channel"
                }
              }
            }
          }
