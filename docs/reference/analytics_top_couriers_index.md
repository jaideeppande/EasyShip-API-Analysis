...
```json
{
  ...
  "paths": {
    "/2024-09/analytics/top_couriers": {
      "get": {
        "summary": "List Analytics Top Couriers Data",
        "tags": [
          "Analytics"
        ],
        "operationId": "analytics_top_couriers_index",
        "description": "Retrieve analytics top couriers data.\n\nRequired authorization scope: `public.analytics:read`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "list of top couriers",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "analytics_top_couriers": {
                        ...
                        "total_shipments_count": 10
                      },
                      "meta": {
                        "request_id": "01563646-58c1-4607-8fe0-cae3e92c4477"
                      }
                    },
                    "summary": "list of top couriers"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/analytics_top_couriers_data"
                }
              }
            }
          },
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "List Analytics Top Couriers Data",
                            "url": "https://developers.easyship.com/reference/analytics_top_couriers_index"
                          }
                        ],
  ...
  "components": {
    ...
    "schemas": {
      "analytics_top_couriers_data": {
        "type": "object",
        "description": "Summary Analytics Top Courier Data",
        "additionalProperties": false,
        "properties": {
          "analytics_top_couriers": {
            "$ref": "#/components/schemas/AnalyticsTopCourier"
          },
          "meta": {
          ...
          "couriers": {
            ...
            "items": {
              ...
              "properties": {
                ...
                "shipments_count": {
                  "type": "integer",
                  "description": "Number of shipments for a specific courier"
                },
                "percentage": {
                  "type": "number",
                  "description": "Percentage of shipments for a specific courier"
                }
              }
            }
          }
