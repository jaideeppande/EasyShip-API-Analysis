...
```json
{
  ...
  "paths": {
    "/2024-09/insurances/policies/{policy_id}/cancel": {
      "post": {
        "summary": "Cancel an Insurance Policy",
        "tags": [
          "Insurance"
        ],
        "operationId": "insurances_policies_cancel",
        "description": "Cancel an insurance policy. Only policies in `awaiting` state can be cancelled.\n\nRequired authorization scope: `public.insurance_policy_from_quote:write`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "insurance policy successfully cancelled",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "success": {
                        "message": "Insurance policy successfully cancelled"
                      },
                      "meta": {
                        "request_id": "01563646-58c1-4607-8fe0-cae3e92c4477"
                      }
                    },
                    "summary": "insurance policy successfully cancelled"
                  }
                },
                "schema": {
              ...
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "insurance policy not found"
                  }
                },
                "schema": {
          ...
          "422": {
            "description": "insurance policy not cancellable",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "error": {
                        ...
                        "details": [
                          "Insurance policy is not cancellable."
                        ],
                        "links": [
                          {
                            "kind": "documentation",
                    ...
                    "summary": "insurance policy not cancellable"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/Error"
