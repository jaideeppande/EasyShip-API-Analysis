...
Retrieve a list of an organization's shipping rules.
  ...
  "paths": {
    "/2024-11/organizations/{organization_id}/shipping_rules": {
      "get": {
        ...
        "operationId": "organizations_shipping_rules_index",
        "description": "Retrieve a list of an organization's shipping rules.\n\nRequired authorization scope: `enterprise.shipping_rule:read`\n",
        "security": [
          {
            "OAuth2": [
        ...
        "responses": {
          "200": {
            "description": "shipping rule list",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "shipping rule list"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/shipping_rule_list"
                }
              }
            }
          }
