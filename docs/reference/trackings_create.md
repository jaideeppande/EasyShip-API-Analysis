...
```json
{
  ...
  "paths": {
    "/2024-09/trackings": {
      "post": {
        ...
        "operationId": "trackings_create",
        "description": "Create a single tracking in your account.\n\nRequired authorization scope: `public.track_3p:write`\n\n> **Note:** This endpoint requires an **advanced scope**. You can enable advanced scopes when creating or editing your [API connection](https://developers.easyship.com/reference/scopes).\n\n> **Note:** Calls to this endpoint count towards your API usage allowance. You can monitor your current usage in the [Subscription section](https://app.easyship.com/account/subscription) of your account.\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "201": {
            "description": "tracking successfully created",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "tracking successfully created"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/tracking_single"
                }
              }
            }
          },
                    ...
                    "value": {
                      "error": {
                        ...
                        "details": [
                          ...
                          "#/components/schemas/TrackingCreate/properties/courier_service_id Value: \"\" is not conformant with UUID format"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              ...
              "examples": {
                "tracking_successfully_created": {
                  "summary": "tracking successfully created",
                  "value": {
                    "tracking_number": "13213213",
  ...
  "components": {
    ...
    "schemas": {
      "tracking_single": {
        "type": "object",
        "description": "Single tracking with all its details",
      ...
      "Tracking": {
        ...
        "properties": {
          ...
          "tracking_page_url": {
            ...
            "format": "uri",
            "nullable": true,
            "description": "Tracking page URL. If certain condition is met, it will be empty."
          },
          "eta_date": {
            "type": "string",
            "format": "date-time",
      ...
      "TrackingCreate": {
        "type": "object",
        "description": "Tracking Create params",
        "required": [
          "tracking_number"
        ],
        "properties": {
          ...
          "origin_address_id": {
            "type": "string",
            "format": "uuid",
            "description": "ID of origin address. Required if the `origin_address` object is not provided. If provided, the origin address attributes will be ignored."
          },
          "origin_address": {
            "$ref": "#/components/schemas/Address"
          },
          ...
          "items": {
            ...
            "items": {
              ...
              "properties": {
                ...
                "quantity": {
                  "type": "number",
                  "description": "Quantity of the item. It will be set to 1 if not provided."
                }
              }
            }
          }
