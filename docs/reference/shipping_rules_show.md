  ...
  "paths": {
    "/2024-09/shipping_rules/{shipping_rule_id}": {
      "get": {
        ...
        "operationId": "shipping_rules_show",
        "description": "Retrieve a shipping rule.\n\nRequired authorization scope: `public.shipping_rule:read`\n",
        "security": [
          {
            "Bearer": []
          }
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Get a Shipping Rule",
                            "url": "https://developers.easyship.com/reference/shipping_rules_show"
                          },
                          {
                            "kind": "how-to-guide",
