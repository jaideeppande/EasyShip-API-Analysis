  ...
  "paths": {
    "/2024-09/shipping_rules/{shipping_rule_id}/conditions/{condition_id}": {
      "delete": {
        ...
        "operationId": "shipping_rule_condition_delete",
        "description": "Delete shipping rule condition.\n\nRequired authorization scope: `public.shipping_rule:write` \n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "200": {
            "description": "condition successfully deleted",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "condition successfully deleted"
                  }
                },
                "schema": {
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Delete Condition of a Shipping Rule",
                            "url": "https://developers.easyship.com/reference/shipping_rule_condition_delete"
                          },
                          {
                            "kind": "how-to-guide",
