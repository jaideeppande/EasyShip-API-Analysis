  ...
  "paths": {
    "/2024-09/couriers/{courier_id}": {
      "delete": {
        ...
        "operationId": "couriers_delete",
        "description": "Delete a LYOC courier.\n\nRequired authorization scope: `public.courier:write`\n",
        "security": [
          {
            "Bearer": []
          }
              ...
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "courier successfully deleted"
                  }
                },
                "schema": {
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Delete a Courier",
                            "url": "https://developers.easyship.com/reference/couriers_delete"
                          }
                        ],
