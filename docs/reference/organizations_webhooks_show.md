...
Retrieve details of a specific webhook in the organization.
...
```json
{
  ...
  "paths": {
    "/2024-11/organizations/{organization_id}/webhooks/{webhook_id}": {
      "get": {
        "summary": "Get a Webhook",
        "tags": [
          "Webhooks"
        ],
        "operationId": "organizations_webhooks_show",
        "description": "Retrieve details of a specific webhook in the organization.\n\nRequired authorization scope: `enterprise.webhook:read`\n",
        "security": [
          {
            "OAuth2": [
              "enterprise.webhook"
        ...
        "responses": {
          "200": {
            "description": "returns webhook successfully",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "returns webhook successfully"
                  }
                },
                "schema": {
