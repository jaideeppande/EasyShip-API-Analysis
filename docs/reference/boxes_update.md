  ...
  "paths": {
    "/2024-09/boxes/{box_id}": {
      "patch": {
        ...
        "operationId": "boxes_update",
        "description": "Update a box in your account.\n\nRequired authorization scope: `public.box:write`\n",
        "security": [
          {
            "Bearer": []
          }
              ...
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "box successfully updated"
                  }
                },
                "schema": {
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            "kind": "documentation",
                            "name": "Update a Box",
                            "url": "https://developers.easyship.com/reference/boxes_update"
                          }
                        ],
