...
```json
{
  ...
  "paths": {
    "/2024-11/companies/{easyship_company_id}/downgrade_subscription": {
      "parameters": [
        {
      ...
      "post": {
        ...
        "operationId": "downgrade_subscription_create",
        "description": "Switch a specific child company to the free-tier subscription plan.\nThe free-tier plan takes effect upon expiration of the current plan period.\n\nRequired authorization scope: `enterprise.company:write`\n",
        "security": [
          {
            "OAuth2": [
              "enterprise.company"
        ...
        "responses": {
          "200": {
            "description": "subscription successfully switched to free plan",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "subscription": {
                        "end_at": "2022-03-24T12:21:00Z",
                        "next_invoice_at": "2024-11-09T09:35:20Z",
                        "next_subscription": {
                          "end_at": null,
                          "next_invoice_at": "2026-06-06T00:00:00Z",
                          "start_at": "2022-03-24T12:21:00Z",
                          "subscription_plan": {
                            "amount": 0,
                            "currency": "HKD",
                            "interval": "month",
                          ...
                          "subscription_state": "activated",
                          "trial_end_at": null
                        },
                        "start_at": "2022-02-21T12:21:00Z",
                        "subscription_plan": {
                          "amount": 0,
                          "currency": "HKD",
                          "interval": "month",
                    ...
                    "summary": "subscription successfully switched to free plan"
                  }
                },
                "schema": {
          ...
          "404": {
            "description": "child company was not found",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "child company was not found"
                  }
                },
                "schema": {
    ...
    "schemas": {
      ...
      "Plan": {
        ...
        "properties": {
          ...
          "interval": {
            "type": "string",
            "description": "Billing frequency of the subscription plan",
            "enum": [
              "month",
              "year"
            ]
          ...
          "amount": {
            "type": "number",
            "description": "Total amount for the subscription plan"
          }
        }
      },
      "Subscription": {
        ...
        "properties": {
          ...
          "next_invoice_at": {
            "type": "string",
            "description": "Next billing date of the subscription"
          },
          "trial_end_at": {
            "type": "string",
            "nullable": true,
            "description": "End date of the subscription trial period"
          },
          "start_at": {
            "type": "string",
          ...
          "next_subscription": {
            "type": "object",
            "nullable": true,
            "description": "Next subscription after expiration of the current one",
            "additionalProperties": false,
            "properties": {
              "subscription_plan": {
                "$ref": "#/components/schemas/Plan"
