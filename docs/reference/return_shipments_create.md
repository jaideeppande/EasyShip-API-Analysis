  ...
  "paths": {
    "/2024-09/shipments/{easyship_shipment_id}/return": {
      "post": {
        ...
        "operationId": "return_shipments_create",
        "description": "Create a new return shipment from an existing shipment.\n\nRequired authorization scope: `public.shipment:write`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
          "201": {
            "description": "return shipment with empty parcels successfully created",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "shipment": {
                        "easyship_shipment_id": "ESSG10000814",
                        ...
                        "origin_address": {
                          "city": "New York City",
                          "company_name": "Test McTest",
                          "contact_email": "test@test.com",
                          "contact_name": "Test McTest",
                          "contact_phone": "+12122217511",
                          "country_alpha2": "US",
                          "line_1": "5th Ave at 42nd St",
                          "line_2": "Block 3",
                          "postal_code": "10023",
                          "state": "New York"
                        },
                        ...
                        "rates": [
                          {
                            ...
                            "residential_full_fee": 0,
                            "sales_tax": 0,
                            "shipment_charge": 1449,
                            "shipment_charge_total": 1593.9,
                            "total_charge": 1593.9,
                            "tracking_rating": 2,
                        ...
                        "tracking_page_url": "http://api.easyship.com:9003/shipment-tracking/ESSG10000814",
                        "trackings": [],
                    ...
                    "summary": "return shipment with empty parcels successfully created"
                  }
                },
                "schema": {
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Create a Return Shipment",
                            "url": "https://developers.easyship.com/reference/return_shipments_create"
                          },
                          {
                            "kind": "how-to-guide",
                            "name": "How to Create a Return Shipment",
                            "url": "https://developers.easyship.com/docs/how-to-create-a-return-shipment"
                          }
                        ],
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/ReturnSingleShipmentCreate"
              },
              "examples": {
                "return_shipment_with_empty_parcels_successfully_created": {
                  "summary": "return shipment with empty parcels successfully created",
                  "value": {
                    "destination_address_id": "01563646-58c1-4607-8fe0-cae3e33c0002",
                    "courier_settings": {
      ...
      "ReturnSingleShipmentCreate": {
        ...
        "properties": {
          "destination_address_id": {
            "type": "string",
            "format": "uuid",
            "description": "Address ID that will be loaded as destination address. The return address of the original shipment will be used when `destination_address_id` is not provided."
          },
          "courier_settings": {
          ...
          "parcels": {
            ...
            "items": {
              ...
              "properties": {
                ...
                "total_actual_weight": {
                  "type": "number",
                  "description": "Total weight of the shipment, including the box weight. If you provide the total weight of the shipment, then the actual_weight for items can be optional."
                },
                "items": {
                  "type": "array",
                  "description": "If not specified, all items from the shipment will be used.",
                  "items": {
                    "type": "object",
                    "additionalProperties": false,
                    "required": [
                    ...
                    "properties": {
                      "id": {
                        "type": "string",
                        "format": "uuid",
                        "description": "Item ID from the shipment."
                      },
                      "quantity": {
                        "type": "integer",
                        "description": "If not provided, the quantity from the shipment for this item will be used.",
                        "nullable": true
                      }
                    }
                  }
            ...
            "properties": {
              "additional_services": {
                ...
                "properties": {
                  "qr_code": {
                    "type": "string",
                    "description": "Generate QR code when generating label. If a courier does not support it, label will be generated without the QR code. Currently officially supported only for USPS courier and Canada Post domestic shipment. For Canada Post, only allow the `qr_code` option. When set to `qr_code` for USPS, both the QR code and the original label are returned. `qr_code_with_label` is deprecated and no longer supported; if provided, it silently falls back to `qr_code`. Label customization is not available for USPS. **Subject to change.**",
                    "default": "none",
                    "enum": [
                      "qr_code",
                      "qr_code_with_label",
