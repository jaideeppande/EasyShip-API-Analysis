...
> 🚧 Warning
> 
> This endpoint uses **api-sandbox.easyship.com** domain. The full URL, without query params, is `https://api-sandbox.easyship.com`.
...
```json
{
  ...
  "paths": {
    "/2024-09/sandbox/trackings/{tracking_id}": {
      "patch": {
        ...
        "operationId": "sandbox_trackings_update",
        "servers": [
          {
        ...
        "description": "Update a tracking (Sandbox only)\n\nThis endpoint is intended for testing tracking status updates and is exclusively available in the Sandbox environment.\n\nRequired authorization scope: `public.track_3p:write`\n\n> 🚧 Warning\n> \n> This endpoint uses **api-sandbox.easyship.com** domain. The full URL, without query params, is `https://api-sandbox.easyship.com`.\n> *This docs platform does not fully support OpenAPI and uses/displays the global URL instead of the correct one.*\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          {
            ...
            "in": "path",
            "required": true,
            "description": "Tracking ID provided when creating",
            "schema": {
              "type": "string"
            }
          }
        ...
        "responses": {
          "200": {
            "description": "tracking successfully updated",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "tracking successfully updated"
                  }
                },
                "schema": {
              ...
              "application/json": {
                "examples": {
                  "default": {
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "Update a Sandbox Tracking",
                            "url": "https://developers.easyship.com/reference/sandbox_trackings_update"
                          }
                        ],
                    ...
                    "summary": "failed to update tracking"
                  }
                },
                "schema": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/SandboxTrackingUpdate"
              }
            }
          }
        }
  ...
  "components": {
    ...
    "schemas": {
      ...
      "SandboxTrackingUpdate": {
        "type": "object",
        "description": "Update a Tracking in sandbox environment",
        "additionalProperties": false,
        "properties": {
          "status_slug": {
            "type": "string",
            "description": "The abbreviation of the tracking status",
            "enum": [
              "in_transit_to_customer",
              "out_for_delivery",
              "failed_attempt",
