  ...
  "paths": {
    "/2024-09/pickups/{easyship_pickup_id}": {
      "get": {
        ...
        "operationId": "pickups_show",
        "description": "Retrieve details of a specific pickup.\n\nRequired authorization scope: `public.pickup:write`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          {
            "name": "easyship_pickup_id",
            "in": "path",
            "required": true,
            "description": "Easyship Pickup ID",
            "schema": {
              "type": "string"
            }
          }
        ...
        "responses": {
          "200": {
            "description": "returns pickup successfully",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "returns pickup successfully"
                  }
                },
                "schema": {
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            "kind": "documentation",
                            "name": "Get a Pickup",
                            "url": "https://developers.easyship.com/reference/pickups_show"
                          },
                          {
                            "kind": "how-to-guide",
