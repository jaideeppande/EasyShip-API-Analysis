  ...
  "paths": {
    "/2024-09/shipping_rules": {
      "post": {
        ...
        "operationId": "shipping_rules_create",
        "description": "Create a shipping rule.\n\nRequired authorization scope: `public.shipping_rule:write`\n",
        "security": [
          {
            "Bearer": []
          }
                    ...
                    "value": {
                      "error": {
                        ...
                        "details": [
                          ...
                          "#/components/schemas/ShippingRuleCreate missing required parameters: description, conditions, actions"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
