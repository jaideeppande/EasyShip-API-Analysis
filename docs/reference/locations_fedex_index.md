...
This endpoint routes requests to the FedEx Location API. For further information, kindly look into the FedEx API documentation available at https://developer.fedex.com/api/en-kr/catalog/locations/v1/docs.html.
...
```json
{
  ...
  "paths": {
    "/2024-09/locations/fedex": {
      "get": {
        "summary": "List FedEx Locations",
        "tags": [
          "Locations"
        ],
        "operationId": "locations_Fedex_index",
        "description": "Retrieve FedEx locations.\n\nThis endpoint routes requests to the FedEx Location API. For further information, kindly look into the FedEx API documentation available at https://developer.fedex.com/api/en-kr/catalog/locations/v1/docs.html.\n\nRequired authorization scope: `public.location:read`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          ...
          },
          {
            ...
            "required": false,
            "description": "Specifies the distance value."
          }
        ],
        "responses": {
          "200": {
            "description": "list courier service points",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                      ...
                      "locations": [
                        {
                          ...
                          "location_type": "FEDEX_AUTHORIZED_SHIP_CENTER",
                          "name": "jhon",
                          "opening_hours": [
                            {
                              "day": "MONDAY",
                    ...
                    "summary": "list courier service points"
                  }
                },
                "schema": {
                  "$ref": "#/components/schemas/location_fedex_list"
                }
              }
            }
          },
                    ...
                    "value": {
                      "error": {
                        ...
                        "links": [
                          ...
                          {
                            "kind": "documentation",
                            "name": "List FedEx Locations",
                            "url": "https://developers.easyship.com/reference/locations_fedex_index"
                          }
                        ],
  ...
  "components": {
    ...
    "schemas": {
      "location_fedex_list": {
        "type": "object",
        "description": "List of FedEx locations",
        "additionalProperties": false,
        "properties": {
          "locations": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/LocationFedex"
            }
          },
          "meta": {
      ...
      "LocationFedex": {
        "allOf": [
          ...
          {
            "description": "FedEx Location",
            "type": "object",
            "properties": {
              "location_type": {
                "type": "string",
                "description": "Type of the location (only available for FedEx).",
                "enum": [
