  ...
  "paths": {
    "/2024-09/pickups/{pickup_id}/shipments": {
      "get": {
        ...
        "operationId": "pickups_shipments_index",
        "description": "Retrieve a list of pickup's shipments.\n\nRequired authorization scope: `public.shipment:read`\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "query",
            "required": false,
            "description": "Order number on the sales platform.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "in": "query",
            "required": false,
            "description": "Search for shipments created since this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "in": "query",
            "required": false,
            "description": "Search for shipments created before this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "in": "query",
            "required": false,
            "description": "Search for shipments updated since this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "in": "query",
            "required": false,
            "description": "Search for shipments updated before this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            "name": "label_paid_at_from",
            "in": "query",
            "required": false,
            "description": "Search for shipments where the labels were paid for since this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            "name": "label_paid_at_to",
            "in": "query",
            "required": false,
            "description": "Search for shipments where the labels were paid for before this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            "name": "label_generated_at_from",
            "in": "query",
            "required": false,
            "description": "Search for labels generated since this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            "name": "label_generated_at_to",
            "in": "query",
            "required": false,
            "description": "Search for labels generated before this date: ISO8601 date format.",
            "schema": {
              "type": "string"
            }
          },
          {
            ...
            "required": false,
            "description": "Search by current status of shipment."
          },
          {
            "name": "label_state",
            "in": "query",
            ...
            "explode": false,
            "required": false,
            "description": "Search by current label status of shipment."
          },
          {
            "name": "pickup_state",
            "in": "query",
            ...
            "explode": false,
            "required": false,
            "description": "Search by current pickup status of shipment."
          },
          {
            "name": "delivery_state",
            "in": "query",
            ...
            "explode": false,
            "required": false,
            "description": "Search by current delivery status of shipment."
          },
          {
            ...
            "explode": false,
            "required": false,
            "description": "For eFulfilment only. Search by current warehouse status of shipment."
          },
          {
            ...
            "explode": false,
            "required": false,
            "description": "Search by the shipment origin country code: Alpha-2 format (ISO 3166-1)."
          },
          {
            ...
            "required": false,
            "description": "Search by shipment destination country code: Alpha-2 format (ISO 3166-1)."
          },
          {
            "name": "return",
            "in": "query",
            "required": false,
            "description": "Search by shipment whether the shipment is return shipment or not.",
            "schema": {
              "type": "string"
            }
          }
        ...
        "responses": {
          "200": {
            "description": "list of pickup's shipments",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "list of pickup's shipments"
                  }
                },
                "schema": {
