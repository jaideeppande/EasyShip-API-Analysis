...
```json
{
  ...
  "paths": {
    "/2024-09/batches/addresses": {
      "post": {
        "summary": "Create a Batch of Addresses",
        "tags": [
          "Batches"
        ],
        "operationId": "batch_addresses_create",
        "description": "Create a batch of addresses.\n\nRequired authorization scopes: `public.batch:write`, `public.address:write`\n",
        "security": [
          {
            "Bearer": []
          }
                    ...
                    "value": {
                      "error": {
                        ...
                        "details": [
                          ...
                          "#/components/schemas/BatchAddressesCreate missing required parameters: addresses"
                        ],
                        "links": [
                          {
                            "kind": "documentation",
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/BatchAddressesCreate"
              },
              "examples": {
                "batch_successfully_created": {
                  ...
                  "value": {
                    ...
                    "addresses": [
                      {
                        "city": "Yau Ma Tei",
                        "company_name": "Test Lc",
                        "contact_email": "chong@home.com",
                        "contact_name": "Chong Wei Lan",
                        "contact_phone": "+852-3008-4444",
                        "line_1": "In's Point",
                        "line_2": "Block 434",
                        "postal_code": "0000",
