  ...
  "paths": {
    "/2024-09/shipments/{easyship_shipment_id}": {
      "delete": {
        ...
        "operationId": "shipments_delete",
        "description": "Delete a shipment before a label has been requested (`label_state: not_created`).\n\nRequired authorization scope: `public.shipment:write`\n\n> **Cancel vs Delete:** Use **Delete** to remove a shipment before a label has been requested (`label_state: not_created`). Use **Cancel** after a label has been requested, as long as the shipment is not yet in transit.\n",
        "security": [
          {
            "Bearer": []
          }
        ...
        "responses": {
              ...
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "shipment successfully deleted"
                  }
                },
                "schema": {
          ...
          "404": {
            "description": "shipment not found or not in a deletable state",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                      ...
                      "error": {
                        ...
                        "links": [
                          ...
                          },
                          {
                            ...
                            "url": "https://developers.easyship.com/reference/shipments_delete"
                          },
                          {
                            "kind": "how-to-guide",
                    ...
                    "summary": "shipment has been shipped"
                  }
                },
                "schema": {
