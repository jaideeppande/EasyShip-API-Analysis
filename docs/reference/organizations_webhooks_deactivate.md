...
Deactivates a single webhook for your organization.
...
```json
{
  ...
  "paths": {
    "/2024-11/organizations/{organization_id}/webhooks/{webhook_id}/deactivate": {
      "post": {
        "summary": "Deactivate a Webhook",
        "tags": [
          "Webhooks"
        ],
        "operationId": "organizations_webhooks_deactivate",
        "description": "Deactivates a single webhook for your organization.\n\nRequired authorization scope: `enterprise.webhook:write`\n",
        "security": [
          {
            "OAuth2": [
              "enterprise.webhook"
        ...
        "responses": {
              ...
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "webhook successfully deactivated"
                  }
                },
                "schema": {
          ...
          "400": {
            "description": "failed to deactivate webhook",
            "content": {
              "application/json": {
                "examples": {
                  "default": {
                    ...
                    "summary": "failed to deactivate webhook"
                  }
                },
                "schema": {
