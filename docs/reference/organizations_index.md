...
Required authorization scope: `enterprise.organization:read`
...
```json
{
  ...
  "paths": {
    "/2024-11/organizations": {
      "get": {
        "summary": "List all Organizations",
        "tags": [
          "Organizations"
        ],
        "operationId": "organizations_index",
        "description": "Retrieve a list of organizations (groups of child companies) that are a part of your group.\n\nRequired authorization scope: `enterprise.organization:read`\n",
        "security": [
          {
            "OAuth2": [
          ...
          "200": {
            ...
            "content": {
              "application/json": {
                ...
                "schema": {
                  "$ref": "#/components/schemas/organization_list"
                }
              }
            }
          }
